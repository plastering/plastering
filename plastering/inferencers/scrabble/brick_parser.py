...
#        tagsetList = json.load(fp)
    ...
    BUILDING = Namespace('https://brickschema.org/schema/1.0.3/building_example#')
    ...
    g.parse('/home/jbkoh/repo/Brick_jbkoh/dist/BrickFrame.ttl', format='turtle')
